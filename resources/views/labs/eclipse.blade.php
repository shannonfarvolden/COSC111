...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/eclipseLocation.png" width="400" height="500"></center>
            ...
            <center><img src="images/browseWorkspace.png" width="700" height="500"></center>
            ...
            <center><img src="images/newWorkspace.png" width="700" height="500"></center>

            <p>
                Now you will be at the main screen of Eclipse as the figure below where we can do our work.
            </p>
            <center><img src="images/homeScreen.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/javaProject.png" width="700" height="500"></center>
            ...
            <center><img src="images/projectName.png" width="700" height="600"></center>
            ...
            Also note, if you are in the wrong perspective and you create a Java Project,
                        ...
                        <center><img src="images/perspective.png" width="700" height="500"></center-->
            ...
            <center><img src="images/updatedWorkspace.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            First,
                        ...
                        <center><img src="images/newClass.png" width="700" height="500"></center>
            ...
            <center><img src="images/newClassRightClick.png" width="700" height="500"></center>

            <p>
                A new screen will pop up that looks like this:
            </p>
            <center><img src="images/classInfo.png" width="700" height="500"></center>
            <p>
            ...
            <center><img src="images/updatedWorkspaceWithClass.png" width="700" height="500"></center>
            <p>
            ...
            <center><img src="images/updatedHelloWorld.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/build.png" width="700" height="500"></center>
            ...
            If this option is grayed out and Build Automatically has a check mark by it,
                        ...
                        <center><img src="images/buildAutomatically.png" width="700" height="500"></center -->
            ...
            <center><img src="images/runButton.png" width="700" height="500"></center>
            ...
            <center><img src="images/output.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/syntaxError.png" width="700" height="500"></center>

            <p>
                When this shows up, you can place our mouse over the red X to view the error
                message, like the screen here:
            </p>
            <center><img src="images/syntaxErrorMessage.png" width="700" height="500"></center>
            <p>
            ...
            <center><img src="images/eclipseRunTimeError.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <p>
            <center><img src="images/switchWorkspace.png" width="700" height="500"></center>
            ...
            <center><img src="images/otherWorkspace2.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/javaEE.png" width="700" height="500"></center>
            ...
            <center><img src="images/changePerspective.png" width="700" height="500"></center>

            <p>
                If however "Java" is not listed, select "Other" then click on "Java" in that list
                and click on "OK" as shown below.
            </p>
            <center><img src="images/otherPerspective.png" width="700" height="500"></center>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <center><img src="images/lineNumberOption.png" width="700" height="500"></center>

            <p>
                This will add line numbers to the left hand side, which just makes things
                easier to read and debug.
            </p>
            <center><img src="images/lineNumbers.png" width="700" height="500"></center -->
