...
@section('content')
    <div class="jumbotron">
        ...
        <p>Due: Sunday 9:00am on Jan 29th</p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ul>
                <li> There are several course components to consider:
                    in-class activities,
                    online quizzes,
                    labs,
                    assignments,
                    midterm 1, midterm 2, and final exam.
                <li> Each course component has a weight towards the final course grade.
                    ...
                    the order they are listed above, the weights are: 10%, 5%, 10%, 15%, 10%,
